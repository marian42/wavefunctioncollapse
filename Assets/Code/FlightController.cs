...
public class FlightController : MonoBehaviour {
	...
	public void OnEnable() {
		...
		this.transform.position = this.transform.position - Vector3.up * this.transform.position.y + Vector3.up * (GameObject.FindObjectOfType<MapBehaviour>().MapGenerator.Height * MapGenerator.BlockSize + 2f);
